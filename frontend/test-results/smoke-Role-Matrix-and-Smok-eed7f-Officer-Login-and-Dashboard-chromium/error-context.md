...
- Name: smoke.spec.ts >> Role Matrix and Smoke E2E >> Safety Officer Login and Dashboard
...
Locator: getByRole('heading', { name: 'Service Logs' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'Service Logs' })
